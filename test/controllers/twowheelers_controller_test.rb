...
class TwowheelersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create twowheeler' do
    assert_difference('Twowheeler.count') do
      post twowheelers_url,
           params: { twowheeler: { description: @twowheeler.description, engine_type: @twowheeler.engine_type,
                                   fuel_type: @twowheeler.fuel_type, image_url: @twowheeler.image_url, model_year: @twowheeler.model_year, name: @twowheeler.name, price: @twowheeler.price } }
    end
  ...
  test 'should update twowheeler' do
    patch twowheeler_url(@twowheeler),
          params: { twowheeler: { description: @twowheeler.description, engine_type: @twowheeler.engine_type,
                                  fuel_type: @twowheeler.fuel_type, image_url: @twowheeler.image_url, model_year: @twowheeler.model_year, name: @twowheeler.name, price: @twowheeler.price } }
